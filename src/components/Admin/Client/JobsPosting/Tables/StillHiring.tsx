...
import { Box, Switch, Typography, AvatarGroup, Avatar, Tooltip } from '@mui/material';
...
const StillHiring: React.FC<ITable> = ({ data }) => {
...

    {
      ...
      renderCell: (params: any) => {
        ...
        if (skills.length > 1) {
          ...
          const normalSkills = skills.join(', ');
          return (
            <Typography className="data-grid-row--items" variant="caption">
              {normalSkills}
            </Typography>
